...
async function main() {
  ...
  // Note: "types" are represented via names/descriptions (schema has no category field).
  // --------------------
  const merchantSpecs = [
    {
      key: 'cleaning',
    ...
    },
    {
      ...
      packages: [
        { name: 'Home Fix Essentials', deal: 29.99, original: 45.0, items: ['Screws Set', 'Wall Hooks', 'Measuring Tape', 'Glue'] },
      ],
    },
    {
      key: 'moving',
      ...
      packages: [
        { name: 'Moving Supplies Pack', deal: 49.99, original: 79.99, items: ['Cardboard Boxes', 'Packing Tape', 'Bubble Wrap', 'Marker Pens'] },
      ],
    },
    {
      key: 'gardening',
      ...
      packages: [
        { name: 'Garden Tool Mini Pack', deal: 24.99, original: 39.99, items: ['Gloves', 'Pruning Shears', 'Garden Bag'] },
      ],
    },
    {
      key: 'carwash',
      ...
      packages: [
        { name: 'Car Care Bundle', deal: 19.99, original: 34.99, items: ['Car Shampoo', 'Microfiber Towels', 'Air Freshener'] },
      ],
    },
    {
      key: 'beauty',
      ...
      packages: [
        { name: 'Skincare Starter Pack', deal: 39.99, original: 59.99, items: ['Cleanser', 'Moisturizer', 'Sunscreen'] },
      ],
    },
    {
      key: 'petcare',
      ...
      packages: [
        { name: 'Pet Treats Box', deal: 24.99, original: 39.99, items: ['Dog Treats', 'Cat Treats', 'Chew Toy'] },
      ],
    },
    {
      key: 'tutoring',
      ...
      packages: [
        { name: 'Stationery Combo', deal: 14.99, original: 24.99, items: ['Notebook', 'Pens Set', 'Highlighters'] },
      ],
    },
    {
      key: 'appliance',
      ...
      packages: [
        { name: 'Home Electrical Basics', deal: 19.99, original: 29.99, items: ['Extension Cord', 'Batteries Pack', 'LED Bulbs'] },
      ],
    },
    // Special: Mooncake store
    {
      key: 'mooncake',
      ...
      packages: [
        ...
        },
        {
          ...
          original: 79.9,
          items: [
            'Matcha Lava Mooncake x2',
            'Durian Snow Skin Mooncake x2',
            'Cheese Custard Mooncake x2',
            'Low-Sugar Mixed Nut Mooncake x2',
          ],
        },
        {
          name: 'Mini Mooncake Sharing Pack (12 pcs)',
          deal: 39.9,
          original: 59.9,
          items: ['Mini Mooncakes (Assorted Flavors) x12', 'Sharing Pack Packaging x1'],
        },
      ],
    },
  ] as const;
  ...
  // Extra templates to make the catalog richer (especially for group-buy packages)
  ...
  for (let i = 0; i < merchantSpecs.length; i++) {
    ...
    const phone = `02200002${String(i + 1).padStart(2, '0')}`; // 0220000201...
    ...
    const allServices = [
      ...spec.services,
      ...(extraServiceTemplates[spec.key] || []),
    ];
    ...
    const allPackages = [
      ...spec.packages,
      ...(extraPackageTemplates[spec.key] || []),
    ];
