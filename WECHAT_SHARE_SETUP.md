...
app.get('/order', (req: Request, res: Response) => {
  ...
  res.render('public/order', { 
    baseUrl,
    shareTitle: '团购下单 - 超值优惠商品',
    shareDescription: '优质团购商品，超值优惠价格，快速配送服务',
    shareImage: `${baseUrl}/images/share-card.jpg`
  });
});
```
...
```html
<meta property="og:title" content="<%= shareTitle || '团购下单' %>">
<meta property="og:description" content="<%= shareDescription || '优质团购商品' %>">
<meta property="og:image" content="<%= shareImage || baseUrl + '/images/share-card.jpg' %>">
```
